...
import { BookOpen, LayoutGrid, History, Lock, Settings as SettingsIcon } from 'lucide-react';
    ...
    <div className="min-h-screen lg:flex">
      <aside className="hidden w-64 shrink-0 flex-col border-r border-border bg-surface lg:flex">
        <div className="flex items-center gap-2.5 px-5 py-6">
          ...
          <div>
            <div className="text-sm font-bold text-ink">Study Space</div>
            <div className="text-[11px] font-medium text-muted-2">Table & room booking</div>
          </div>
        </div>
      ...
      <div className="sticky top-0 z-40 border-b border-border bg-surface lg:hidden">
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold text-ink">Study Space</span>
          </div>
